...
class ImagePath {
  ...
  // Logo
  static const String LOGO_DARK = "$imageDir/logo_port.png";
  static const String LOGO_LIGHT = "$imageDir/logo_port.png";
  static const String LOGO_FLUTTER = "$imageDir/flutter_logo.png";
  static const String LOGO_FIREBASE = "$imageDir/firebase_logo.png";
  static const String LOGO_NODEJS = "$imageDir/nodejs_logo.png";
  static const String LOGO_AE = "$imageDir/ae_logo.png";
  ...
  static const String GHANA_FLAG = "$imageDir/thai_flag.jpeg";
